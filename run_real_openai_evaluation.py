"""
Run non-circular CSCE evaluation with real OpenAI API calls
"""
...
def main():
    """Run evaluation with real OpenAI API"""
    print("=== REAL OPENAI API EVALUATION (GPT-4o) ===")
    ...
    print("This will make real API calls and may take a few minutes...")
    
    results = tester.run_evaluation(num_humaneval=3, num_mbpp=3)
    
    with open('/home/ubuntu/real_openai_gpt4o_results.json', 'w') as f:
        json.dump(results, f, indent=2)
    
    analysis = results['analysis']
    print("\n=== REAL OPENAI EVALUATION RESULTS ===")
    ...
    print(f"\nResults saved to real_openai_gpt4o_results.json")
